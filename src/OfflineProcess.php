...
class OfflineProcess
{
     ...
     */
    public function __construct($accessKeyId, $accessKeySecret, $countryCode, $projectEnv = 0, $linkType = 0, $logType = 0, $configData = array())
    {
        if ($logType == 0) {
            //阿里云日志
            $this->logChannel = new AliyunLog($accessKeyId, $accessKeySecret, $countryCode, $projectEnv, $linkType, $configData);
        }
    }
